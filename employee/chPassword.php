<?php
		...
		{	
			...
			{
				DBopen();
				$uId = mysql_query ("SELECT * FROM login_table WHERE login_name='$_SESSION[login_employee]'");
				...
				if($old==$pass)
				{
					if($new==$cpass)
					{
						$log = mysql_query ("UPDATE login_table SET password='$new' WHERE login_name='$_SESSION[login_employee]'");
