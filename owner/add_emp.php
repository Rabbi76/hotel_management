		...
		if($cpass==$pass) 
		{
			...
			if($i==0)
			{
				...
				if($j==0)
				{
					...
					$result = mysql_query ("INSERT INTO login_table(login_name,user_type,password,user_id) VALUES('$un','$type','$pass','$id')");
			...
			<div id="login">
				...
				<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
					<fieldset>
						...
						<p>Password:<input type="hidden" required name="Password" value="1234"> 1234 </p>
