<?php
		...
		{	
			...
			{
				DBopen();
				$uId = mysql_query ("SELECT * FROM login_table WHERE login_name='$_SESSION[login_admin]'");
				...
				if($old==$pass)
				{
					if($new==$cpass)
					{
						$log = mysql_query ("UPDATE login_table SET password='$new' WHERE login_name='$_SESSION[login_admin]'");
...
<html>
	...
	<body>
		...
		<a href="admin.php"><img src="../images/paradise.png" alt="Work" style="width:100px;height:88px;"></a>
		...
		<div>
			<ul class="data"; align="left">
				...
				<li class="data"; > <a href="management.php">Reservation Status</a></li>
		...
		<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
				...
				<p >Confirm Password<br/><input type="text" required name="cpass" value="Conform Password" onBlur="if(this.value=='')this.value='Conform Password'" onFocus="if(this.value=='Conform Password')this.value='' "></p>
