<?php
		...
		{	
			...
			$user = mysql_query ("INSERT INTO reservation(re_name,re_address,re_phone,re_email,re_country,re_std,re_end,rec_room,ref_room,res_room,adult,child,req_by_log) VALUES('$name','$address','$phone','$email','$country','$std','$etd','$croom','$froom','$sroom','$adult','$child','$id')");
			DBclose();
		}
?>
<html>
	...
	<body>
		...
		<ul class="data"; align="left">
				...
				<li class="data"; > <a class="active" href="UserReservation.php">Reservation</a></li>
