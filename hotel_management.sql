...
--
-- Host: 127.0.0.1
-- Generation Time: May 03, 2016 at 08:42 AM
...
INSERT INTO `hotel_room` (`room_id`, `room_type`, `room_status`, `room_rent`) VALUES
(1, 'fm', 'in', 15000);
...
(6, 'anika', 'customer', '1234', 6),
(7, 'jubayer', 'customer', '1234', 7),
(8, 'rabbi_hudai', 'customer', '1234', 8);
...
(10, 'customer2_by_emp', 'nai', 'nai', 'mnf.timu', '123', '16-1-2016', '17-1-2016', '2', '2', '3', '1', '0', 0, 'confirmed', 4),
(11, 'customer45', 'nai45', '45', '4554', '45', '17-4-2016', '18-4-2016', '2', '2', '2', '2', '2', 3, 'pending', NULL),
(13, 'JUBAYER', 'Bolbo na', 'bangladesh', 'jubayersarker31@gmail.com', '01771600131', '3-5-2016', '19-5-2016', '0', '0', '1', '1', '0', 0, 'pending', NULL);
...
(6, 'anika', NULL, NULL, 'fgfgf', 'rtryt', NULL),
(7, 'jubayer', NULL, NULL, '01771600131', 'jubayersarker31@gmail.com', NULL),
(8, 'rabbi_hudai', NULL, NULL, 'rabbi_hudai', 'rabbi_hudai', NULL);
...
--
ALTER TABLE `hotel_room`
  MODIFY `room_id` int(20) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `reservation`
  MODIFY `re_id` int(20) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=14;
--
